...
/* testscript */
static const uint8_t testscript_flash1[] EEMEM = {
...
static const uint8_t testscript_flash2[] EEMEM = {
...
static const uint8_t colorchange_red[] EEMEM = {
...
static const uint8_t colorchange_red_blue[] EEMEM = {
    MACRO_FADE_CHANNEL(CHANNEL_RED, 255, 0x200),
...
static const uint8_t green_flash[] EEMEM = {
    MACRO_FADE_CHANNEL(CHANNEL_GREEN, 255, 0xf00),
    MACRO_WAIT(_BV(CHANNEL_GREEN)),
    MACRO_FADE_CHANNEL(CHANNEL_GREEN, 0, 0x100),
    MACRO_WAIT(_BV(CHANNEL_GREEN)),
...
static const uint8_t green_blink[] EEMEM = {
...
static const uint8_t blinken[] EEMEM = {
